...
(function (jQuery) {
  ...
  /*---------------------------------------------------------------------
          ...
          const checkStockStatus = () => {
            const quantity = parseInt(quantityInput.value, 10); // Corrected the base to 10
          
            if (isNaN(quantity) || quantity <= 0) { // Added isNaN check
              stockStatus.textContent = 'Out of Stock';
              stockStatus.classList.remove('badge-success', 'badge-warning');
              stockStatus.classList.add('badge-danger');
            } else if (quantity <= LOW_STOCK_THRESHOLD) {
              stockStatus.textContent = 'Low in Stock';
              stockStatus.classList.remove('badge-success', 'badge-danger');
              stockStatus.classList.add('badge-warning');
            } else {
              stockStatus.textContent = 'In Stock';
              stockStatus.classList.remove('badge-danger', 'badge-warning');
